...
import { useLeadRefusalReasonStore } from './leadRefusalReason'

jest.mock('@/api/leadRefusalReason', () => ({
  findAll: jest.fn(),
  find: jest.fn(),
  delete: jest.fn(),
  save: jest.fn(),
...
describe('Lead Refusal Reason Store', () => {
  beforeEach(() => {
  ...
  describe('Store Creation', () => {
    it('should create store instance', () => {
      const store = useLeadRefusalReasonStore()
  ...
  describe('API Integration', () => {
    it('should use leadRefusalReason API', () => {
      const store = useLeadRefusalReasonStore()
