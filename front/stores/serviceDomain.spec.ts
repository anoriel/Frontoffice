...
import { useServiceDomainStore } from './serviceDomain'

jest.mock('@/api/serviceDomain', () => ({
  findAll: jest.fn(),
  find: jest.fn(),
  delete: jest.fn(),
  save: jest.fn(),
...
describe('Service Domain Store', () => {
  ...
  describe('Store Creation', () => {
    it('should create store instance', () => {
      const store = useServiceDomainStore()
  ...
  describe('API Integration', () => {
    it('should use serviceDomain API', () => {
      const store = useServiceDomainStore()
