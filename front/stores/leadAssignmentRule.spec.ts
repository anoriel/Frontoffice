...
import { useLeadAssignmentRuleStore } from './leadAssignmentRule'

jest.mock('@/api/leadAssignmentRule', () => ({
  findAll: jest.fn(),
  find: jest.fn(),
  delete: jest.fn(),
  save: jest.fn(),
...
describe('Lead Assignment Rule Store', () => {
  beforeEach(() => {
  ...
  describe('Store Creation', () => {
    it('should create store instance', () => {
      const store = useLeadAssignmentRuleStore()
  ...
  describe('API Integration', () => {
    it('should use leadAssignmentRule API', () => {
      const store = useLeadAssignmentRuleStore()
