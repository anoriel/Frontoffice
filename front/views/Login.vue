  ...
  <v-container>
    <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
      ...
      <v-text-field
        ...
        density="compact"
        :placeholder="$helpers.capitalizeFirstLetter($t('password'))"
...
async function performLogin() {
  ...
  if (!securityStore.hasError) {
    ...
    let legacyIntranetUrl = securityStore.getLegacyIntranetUrl
    if (legacyIntranetUrl != null) {
      sessionStorage.setItem('legacyIntranetUrl', legacyIntranetUrl)
    }
