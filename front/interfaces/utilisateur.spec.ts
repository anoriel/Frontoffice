...
describe('Utilisateur Interface', () => {
  describe('Type Structure', () => {
    ...
    it('should allow utilisateur object with all optional properties', () => {
      const utilisateur: Utilisateur = {
        ...
        impersonateUser: { id: 2, nom: 'Admin User' },
  ...
  describe('Property Types', () => {
    ...
    it('should have correct actif boolean type', () => {
      ...
      const inactiveUser: Utilisateur = {
        id: 2,
        actif: false,
        roles: ['ROLE_USER']
      }
  ...
  describe('Real-world Usage', () => {
    ...
    it('should work with partial user data', () => {
      const partialUser: Partial<Utilisateur> = {
        nom: 'Incomplete',
    ...
    it('should work with user creation payload', () => {
      const newUser: Omit<Utilisateur, 'id' | 'stringValue' | 'activeNow' | 'lastPointsPerDate' | 'lastPoints'> = {
        identifiant: 'newuser',
        nom: 'New',
        prenom: 'User',
    ...
    it('should work with user update payload', () => {
      const userUpdate: Partial<Pick<Utilisateur, 'email' | 'actif' | 'lastActivityAt'>> = {
    ...
    it('should work with role-based filtering', () => {
      ...
      const hasAdminRole = (user: Utilisateur) => user.roles.includes('ROLE_ADMIN')
  ...
  describe('Business Logic Properties', () => {
    it('should handle user authentication and authorization', () => {
      const authenticatedUser: Utilisateur = {
        id: 1,
    ...
    it('should handle organizational relationships', () => {
      const organizationalUser: Utilisateur = {
        id: 1,
        agence: {
          id: 1,
          nom: 'Paris Branch',
    ...
    it('should handle user impersonation', () => {
      const impersonatingUser: Utilisateur = {
        id: 1,
        identifiant: 'admin',
        roles: ['ROLE_ADMIN'],
        impersonateUser: {
    ...
    it('should handle display representation', () => {
      const displayUser: Utilisateur = {
        id: 1,
        nom: 'Display',
        prenom: 'User',
        identifiant: 'displayuser',
        email: 'display@company.com',
        stringValue: 'User Display (displayuser) - display@company.com',
        roles: ['ROLE_USER']
      }

      expect(displayUser.stringValue).toBe('User Display (displayuser) - display@company.com')
    })

    it('should handle different role combinations', () => {
      const multiRoleUser: Utilisateur = {
        id: 1,
